  ...
  return (
    <div className="about-container">
      <div className="about-content">
        ...
        {/* <div className="team">
          <span className="heading">Meet Our Team</span><br />
          <strong>[Founder’s Name], Founder & Head Farmer:</strong> With over [number] years of experience in organic farming, [Founder’s Name] leads our farm with a vision for sustainable agriculture and community engagement.<br />
          <strong>[Team Member’s Name], Operations Manager:</strong> [Team Member’s Name] ensures that our farm runs smoothly, coordinating everything from planting schedules to harvest logistics.<br />
          <strong>[Team Member’s Name], Community Outreach Coordinator:</strong> Passionate about education and community, [Team Member’s Name] organizes our workshops, farm tours, and CSA program, helping to bridge the gap between the farm and our customers.
        </div> */}
