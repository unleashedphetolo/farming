  ...
  return (
    ...
    >
          ...
          <Col md={4}>
            <div className="footer-content">
              <div className="footer-links">
                ...
                <a
                  href="https://www.facebook.com/ulterspace"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
                ...
                <a
                  href="https://www.twitter.com/ulterspace_net"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
                ...
                <a
                  href="https://www.instagram.com/ulterspace"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
      ...
      0 0 30px #cfcfcf`,
            ...
            >
              &copy; {new Date().getFullYear()} Machad Farming - All Rights
              Reserved.
            </p>
